...
const Meals = (props) => {
    ...
    return (
        <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mx-auto">
            <a href="/">
                <img className="rounded-t-lg w-100 mx-auto" src={strMealThumb} alt="" />
            </a>
            <div className="p-3">
                <Link to={"/foodDetails/"+ strMeal}>
                ...
                <button onClick={showFoodDetails} className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Read more
